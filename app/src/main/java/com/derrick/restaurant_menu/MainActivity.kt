...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Load foods
        listOfFoods.add(Foods("Chicken","Chicken is seasoned, deep fried and can be served with french fries.",R.drawable.chicken))
        ...
        //Assign the list to the gridview id
